...
####### TB_USUARIOS
INSERT INTO tb_usuarios (id, apellido_materno, apellido_paterno, celular, direccion, email, estado, fecha_registro, foto_usuario, nombres, nro_documento, password, usuario, local_id, rol_id) VALUES ('1', 'Chinga', 'Medina', 983489303, 'Jr. Los Oligistos 2339', 'edi@live.it', 1, '2019-06-05', 'no-image.jpg', 'Edinson', 47111025, '$2a$10$86PKoDGKFkbtmEXQuUaQbuJ0vzRGY/tLyUiOsu9VExoajCFsqV5yC', 'edmech', 2, 1);